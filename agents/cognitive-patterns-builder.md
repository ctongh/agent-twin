...
The Phase 2 methodology document (`methodology/template/phase2_cognitive_patterns.md`) defines six analysis dimensions. Address each in order. For each dimension:
