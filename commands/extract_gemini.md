---
description: Capture a Gemini share-link conversation and prepare it (with topic-cluster annotation) for the digital-persona analysis pipeline
argument-hint: [optional Gemini share URL]
---

Execute the digital-persona `extract_gemini` skill. Follow the SKILL.md below exactly, step by step.
